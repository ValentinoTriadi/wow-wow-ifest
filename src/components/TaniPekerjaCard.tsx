...
const harvests = [
    { id: 1, type: 'Sumarno', location: 'Jatinanor', owner: 'Sumarno', image: '/myHarvest/Sumarno.jpg' },
    { id: 2, type: 'Sumanto', location: 'Cibaduyut', owner: 'Wahyu', image: '/myHarvest/Sumanto.jpg' },
  ]
