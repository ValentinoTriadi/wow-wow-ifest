...
export interface DetailPerawatanProps {
...
const DetailPerawatan: React.FC<DetailPerawatanProps> = ({
  luas,
  price,
  skills,
  image,
        ...
        <CardContent className="p-0">
          <div>
            ...
            <div className="mt-5 flex flex-col gap-y-4">
              <h2 className="text-lg font-semibold">Tersedia Perawatan</h2>
            ...
            <div className="mt-5 flex flex-col gap-y-5">
              <h2 className="text-lg font-semibold">Deskripsi Perawatan</h2>
...
export default DetailPerawatan;
